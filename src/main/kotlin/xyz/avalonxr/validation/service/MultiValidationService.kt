 ...
 * @author Atri
 *
 * A derivative type of [ValidationService] which validates a list of input values [I] against a collection of validators
 * conforming to the provided type [T]. Any errors that are discovered in the structure of the provided value are returned
 * as instances of result type [R]. Unlike [SingleValidationService], this interface is useful for when you need to perform
 * validation within the context of a value in a group.
 *
