 ...
 * @author Atri
 *
 * A derivative type of [Validator] which validates a list of input values [I] for errors. Any discovered errors in the
 * structure of the provided value are returned as instances of result type [R]. Unlike [SingleValidator], this
