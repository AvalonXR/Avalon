 ...
 * @author Atri
 *
 * A derivative type of [Validator] which evaluates a singleton input value [I] for errors. Any errors that are discovered
 * in the structure of the provided value are returned as instances of result type [R].
 *
